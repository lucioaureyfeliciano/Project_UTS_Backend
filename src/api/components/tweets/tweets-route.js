...
module.exports = (app) => {
  ...
  // cari tweets terbaru
  route.get('/search/recent', tweetsController.getRecentTweets);

  // ambil tweets tertentu
  route.get('/:id', tweetsController.getTweetByTweetId);
  ...
  route.get('/user/:id/tweets', tweetsController.getTweetsByUserId);
};
